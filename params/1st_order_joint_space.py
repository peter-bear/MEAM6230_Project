...
class Params:
    ...
    use_distance_aware_alpha: bool = True  # true to use distance-to-goal as extra input to gain network
    ...
    def __init__(self, results_base_directory):
        ...
        self.results_path = results_base_directory + 'results/1st_order_joint_space' + suffix + '/'
