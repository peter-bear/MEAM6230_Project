...
def main(name='multi_v2', height=400, width=600):
    root = tk.Tk()
    canvas_widget = tk.Canvas(root, width=width, height=height)
    canvas_widget.height = height
    canvas_widget.pack()
    canvas_widget.old_coords = None
    canvas_widget.trajectory = []
    canvas_widget.trajectories = []
    canvas_widget.start = False
    canvas_widget.sampling_times = []
